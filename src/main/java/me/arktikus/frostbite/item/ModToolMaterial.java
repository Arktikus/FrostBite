...
public enum ModToolMaterial implements ToolMaterial {
    ...
    IRON(MiningLevels.IRON, 800, 1.0f, 2.0f, 14, () -> Ingredient.ofItems(Items.IRON_INGOT)),
    ARKTIRIUM(5, 2800, 10.0f, 5.0f, 20, () -> Ingredient.ofItems(ModItems.ARKTIRIUM));
    ...
    private final Supplier<Ingredient> repairIngredient; //private final Lazy<Ingredient> repairIngredient;
    ...
    private ModToolMaterial(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
        ...
        this.repairIngredient = repairIngredient; //this.repairIngredient = new Lazy<Ingredient>(repairIngredient);
    }
